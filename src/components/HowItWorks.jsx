          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative flex flex-col items-center text-center">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-10 left-1/2 w-full h-0.5 bg-[#CFE8F2] z-0" />
              )}
              <div className="relative z-10 bg-[#19376D] text-white w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold mb-6 shadow-sm">
                {step.number}
              </div>
